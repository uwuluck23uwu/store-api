    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppBannerId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBanners", x => x.AppBannerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttemptsCount = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    MaxAttempts = table.Column<int>(type: "int", nullable: true, defaultValue: 5),
                    TempUserData = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResendCount = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    MaxResendCount = table.Column<int>(type: "int", nullable: true, defaultValue: 3),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "ชิ้น"),
                    ImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Rating = table.Column<decimal>(type: "decimal(3,2)", nullable: true),
